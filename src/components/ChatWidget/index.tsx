...
export const ChatWidget: React.FC = () => {
    ...
    const lastMessageTimeRef = useRef<number>(0); // just to delay messages
    const MESSAGE_DELAY_MS = 1000; // Minimum 1 second between messages
    ...
    const handleSend = async (content: string) => {
        ...
        if (timeSinceLastMessage < MESSAGE_DELAY_MS) {
            const delay = MESSAGE_DELAY_MS - timeSinceLastMessage;
        ...
        const userMessage: Message = {
            ...
            role: 'user',
            content,
            timestamp: lastMessageTimeRef.current
        };
